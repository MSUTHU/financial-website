  ...
  <![endif]-->
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <p5><strong>Coinage Financial</strong> </p5>
                            </a>
                            ...
                            <div class="navbar-btn d-none d-sm-inline-block">
                                <a class="main-btn" data-scroll-nav="0" href="#services">Get Started</a>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                </div> <!-- row -->
        ...
        <div id="home" class="header_slider">
            <div class="container-fluid">
                <div class="slider-active">
                    <div class="single_slider bg_cover d-flex align-items-center" style="background-image: url(assets/images/main1.jpg)">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="slider_content">
                                        <h2 class="slider_title" data-animation="fadeInUp" data-delay="0.2s">You are now in Coinage Fanacial service we welcome you</h2>
                                        
                                        <a class="main-btn" href="#about"1s">View Offers now</a>
                                    </div> <!-- slider content -->
                                </div>
                            </div> <!-- row -->
                        </div> <!-- container -->
                ...
                <div class="col-lg-5">
                    <div class="about_content mt-45">
                        <div class="section_title">
                            ...
                            <h3 class="title">Coinage is Trusted by 36,817+ people in South Africa.</h3>
                        </div> <!-- section title -->
                        <p>Our Vision Is To expand Loan Services Brand Which Will Become The Lead Choice For Individuals In The Whole Of South Africa.</p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section_title text-center pb-15">
                        ...
                        <h3 class="title">We Offer Best loans in a lower interest</h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_services text-center mt-30 wow fadeInUpBig" data-wow-duration="2s" data-wow-delay="0.2s">
                        ...
                        <div class="services_content">
                            <h4 class="services_title"><a href="#">Micro Loans</a></h4>
                                <h3>Loan From R400 To R4000</h3><div>
                            
                            
                                <h4>Benefits</h4>
                            </div>
                            <p>
                                <li>Get up to R4000.00 loan.</li>

                                <li>Cover your emergency cash needs.</li>

                                 <li>Access easy online loans.</li>

                                 <li>Convenient and easy application process.Friendly and helpful staff</li>
                            </p>
                        </div>
                    </div> <!-- single services -->
                </div> 
                <div class="col-lg-4 col-sm-6">
                    <div class="single_services text-center mt-30 wow fadeInUpBig" data-wow-duration="2s" data-wow-delay="0.5s">
                        ...
                        <div class="services_content">
                            <h4 class="services_title"><a href="#">Investments</a></h4>
                            <p>This product is designed for any investor who wants to see their money grow. Invest as little as R1 000 per month</p><div><div></div></div>
                            <p><strong>What do we do with your money?</strong></p><div><div></div></div>
                            <li>
                              <p>Coinage will loan out your money and perform all the required tasks from finding the client to collection of the funds.
                            </p>  
                            </li>
                            <li>
                                <p>
                                    We will be doing all the promotions and marketing with no extra cost to you.

                                </p>
                            </li>
                            <li>
                                <p>
                                    We will manage the entire process and all client interactions with no extra cost to you.

                                </p>
                            </li>
                             <li>
                                <p>
                                     We will be taking care of the operational cost, legal cost and all the collection process for you.
    ...
    <section id="blog" class="blog_area pt-95 pb-100">
        ...
        <div class="text-center">
                                        <h2></h2>
                                        <p style="color: #333;"></p>
                                        <a class="main-btn" href="#services" data-animation="fadeInUp" data-delay="1s" tabindex="0" style="animation-delay: 1s;">chat with us Now</a>
                                    </div>
        </div> <!-- container -->
    </section>
        ...
        <div class="container">
            <div class="footer_wrapper pt-50 pb-100">
                <div class="row">
                 ...
                 <p class="text-center pb-30">Designed and Developed by <a href="https://uideck.com" rel="nofollow">Ascent Tech SA</a> </p>
        </div> <!-- container -->
    </footer>
